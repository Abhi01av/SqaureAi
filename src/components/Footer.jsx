        ...
        <div className="footer-top">
          <div className="footer-brand">
            ...
            <p className="footer-tagline">
              Intelligent automation for the enterprise. Powered by AI. Built on AWS.
            </p>
            <div className="footer-aws-badge">
              <svg width="28" height="18" viewBox="0 0 40 20">
                <text x="0" y="15" fontFamily="Arial Black" fontSize="13" fontWeight="900" fill="#f59e0b">aws</text>
              </svg>
          ...
          <div className="footer-links-group">
            ...
            <ul>
              ...
              <li><Link to="/services">MLOps & Data Eng</Link></li>
            </ul>
          </div>
